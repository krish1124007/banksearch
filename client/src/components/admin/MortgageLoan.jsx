...
const MortgageLoan = ({ onChange }) => {
  ...
  const labelMap = {
    "Residential Self Occupied": "residential_self_occupied",
    "Residential Rented": "residential_rented",
    "Residential Vacant": "residential_vacant",
    "Commercial Self Occupied": "commercial_self_occupied",
    "Commercial Rented": "commercial_rented",
    "Commercial Vacant": "commercial_vacant",
    "Industrial Self Occupied": "industrial_self_occupied",
    "Industrial Rented": "industrial_rented",
    "Industrial Vacant": "industrial_vacant",
    "Plot Residential": "plot_residential",
    "Plot Commercial": "plot_commercial",
    "Plot Industrial": "plot_industrial",
    "Godown Self Occupied": "godown_self_occupied",
    "Godown Rented": "godown_rented",
    "Godown Vacant": "godown_vacant",
    "Warehouse Self Occupied": "warehouse_self_occupied",
    "Warehouse Rented": "warehouse_rented",
    "Warehouse Vacant": "warehouse_vacant",
    "School Self Occupied": "school_self_occupied",
    "School Rented": "school_rented",
    "PG Self Occupied": "pg_self_occupied",
    "PG Rented": "pg_rented",
    "PG Vacant": "pg_vacant",
    "Hospital Self Occupied": "hospital_self_occupied",
    "Hospital Rented": "hospital_rented"
  };

  const resetMortgageLoanState = () => {
          ...
          <div className="relative">
            <input
              ...
              onChange={() => {
                setIsEnabled((prev) => {
                  const next = !prev;
                  if (!next) resetMortgageLoanState();
                  return next;
                });
              }}
              className="sr-only"
                      ...
                      {['from', 'to'].map((range) => (
                        <div key={range} className="flex-1">
                          ...
                          <CleanNumberInput
                            ...
                            placeholder={range === 'from' ? 'From' : 'To'}
                          />
                        </div>
                      ))}
                    </div>
