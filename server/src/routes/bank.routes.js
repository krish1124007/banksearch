...
import { createCaseStudy, getAllCaseStudies, deleteCaseStudy, updateCaseStudy } from "../controllers/bank/casestudy.controller.js";
...
router.route('/casestudy/update').post(updateCaseStudy);
